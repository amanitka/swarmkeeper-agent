...
if __name__ == '__main__':
    ...
    scheduler.add_job(func=container_service.cleanup,
                      name="Cleanup job",
                      trigger=CronTrigger(second=cleanup_schedule[0], minute=cleanup_schedule[1],
                                          hour=cleanup_schedule[2], day=cleanup_schedule[3], month=cleanup_schedule[4],
                                          year=cleanup_schedule[5]))
    scheduler.start()
